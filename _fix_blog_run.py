...
:save_region
>"%~dp0blog-region.txt" echo # 블로그 지역
...
path = r"C:\Users\kwj82\Documents\Auto_blog\blog-run.bat"
with open(path, "w", encoding="cp949", newline="\r\n") as f:
    f.write(content)

data = open(path, "rb").read()
print("CRLF", b"\r\n" in data)
print("no BOM", not data.startswith(b"\xef\xbb\xbf"))
print("size", len(data))
