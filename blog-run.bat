...
for /f "usebackq delims=" %%a in (`npx tsx "%~dp0scripts\read-text-line.ts" "%~dp0blog-keywords.txt"`) do set "BLOG_KEYWORDS=%%a"
...
for /f "usebackq delims=" %%a in (`npx tsx "%~dp0scripts\read-text-line.ts" "%~dp0blog-region.txt"`) do set "BLOG_REGION=%%a"
