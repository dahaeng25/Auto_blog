...
echo.
echo 전체 실행을 시작합니다...
call npm.cmd run blog:workflow -- --step full --topic "!BLOG_KEYWORDS!"
goto done
...
echo.
echo 글 작성을 시작합니다...
call npm.cmd run blog:workflow -- --step content --topic "!BLOG_KEYWORDS!"
goto done
...
:edit_keywords
call :edit_keywords_prompt menu
goto menu
